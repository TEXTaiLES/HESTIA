...
TOPIC_DYNAMO_THREAD_SIMULATIONS = 'dynamo_thread_simulations'
TOPIC_DYNAMO_THREAD_SIMULATION_OUTPUTS = 'dynamo_thread_simulation_outputs'
...
TOPIC_DYNAMO_THREAD_SIMULATION_UPLOADED = 'dynamo_thread_simulation_uploaded'
