...
export const CSP_POLICY = "default-src 'self'; script-src 'self' 'unsafe-eval' 'unsafe-inline' https://ajax.googleapis.com; script-src-elem 'self' 'unsafe-inline' https://ajax.googleapis.com https://cdnjs.cloudflare.com; connect-src 'self' https://ajax.googleapis.com https://www.gstatic.com blob:; style-src 'self' 'unsafe-inline' https://cdnjs.cloudflare.com; font-src 'self' https://cdnjs.cloudflare.com; img-src 'self' data: blob:; worker-src 'self' blob:; child-src 'self' blob:;";
